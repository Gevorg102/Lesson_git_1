...
def add(x,y):
    ...
    print(result)                 ## wonc e hramany katarwum
    return res

my_list = [14, 105, 3, 2768, 235, 81]  # arajin cucak@ yndunum e worpes 'x' argument erkrord@ worpes 'y', hashwelis patasxan@ darnum e 'x' isk hajord cucaki hamar@ 'y'
